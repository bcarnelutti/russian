...
const MotionVerbsPrepositionsChart = () => {
  ...
  return (
    <section className="my-12 p-8 bg-white rounded-[3rem] shadow-xl border border-gray-100 min-h-[800px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {prefixes.map((item, index) => (
          <motion.div
            ...
            className={`p-8 rounded-[3rem] border-2 ${item.color} shadow-sm flex flex-col justify-between h-[300px]`}
          >
            <div>
            ...
            <div className="bg-white bg-opacity-60 rounded-[2rem] p-4 backdrop-blur-sm">
              <div className="grid grid-cols-2 gap-4 text-center">
                <div>
                  ...
                  <div className="font-bold text-lg" dangerouslySetInnerHTML={{ __html: underlineStress(item.imp) }} />
                </div>
                <div className="border-l border-gray-300/50">
                  ...
                  <div className="font-bold text-lg" dangerouslySetInnerHTML={{ __html: underlineStress(item.perf) }} />
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <div className="mt-16 bg-slate-50 p-8 rounded-[3rem] border border-slate-200">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center text-lg">
          <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-200 flex-1 w-full text-center">
            ...
            <div className="mt-2 text-sm text-slate-400" dangerouslySetInnerHTML={{ __html: 'Es: в- + ходи́ть = ' + underlineStress('входи́ть') }} />
          </div>
          ...
          <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-200 flex-1 w-full text-center">
            ...
            <div className="mt-2 text-sm text-slate-400" dangerouslySetInnerHTML={{ __html: 'Es: в- + идти́ = ' + underlineStress('войти́') }} />
          </div>
        </div>
      </div>
    </section>
